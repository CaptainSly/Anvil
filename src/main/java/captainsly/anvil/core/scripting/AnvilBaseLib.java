...
public class AnvilBaseLib extends TwoArgFunction implements ResourceFinder {
	...
	public InputStream findResource(String filename) {
		try {
			File f = new File(Utils.WORKING_DIRECTORY + "scripts/" + filename);
